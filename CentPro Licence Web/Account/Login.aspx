<%@ Page Title="Logg inn" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="CentPro_Licence_Web.Account.Login" Async="true" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="row">
        <div class="col-md-8">
            <section id="loginForm">
                <div class="form-horizontal">
                    <h4>Logg inn ved å bruke dine Lisensweb logindetaljer.</h4>
                    <hr />
                    ...
                    <div class="form-group">
                        <asp:Label runat="server" AssociatedControlID="Email" CssClass="col-md-2 control-label">E-post</asp:Label>
                        <div class="col-md-10">
        ...
        <%-- Bruke sosiale medier til å logge inn? --%>
        <div class="col-md-4">
